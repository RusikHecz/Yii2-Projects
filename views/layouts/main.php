...
<head>
    ...
    <link rel="shortcut icon" href="<?= Yii::$app->request->baseUrl ?>/ico/favicon.ico">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="<?= \yii\helpers\Url::home()?>"><?= \yii\helpers\Html::img('@web/images/home/logo.png', ['alt' => 'E-Shopper'])?></a>
                    </div>
                        ...
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                <ul role="menu" class="sub-menu">
                                    ...
                                    <li><a href="#"></a></li>
                                    <li><a href="<?= \yii\helpers\Url::to(['shop/web/admin']) ?>>">Login</a></li>
                                </ul>
                            </li>
    ...
    <div class="footer-top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-7">
                        ...
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/home/iframe1.png" alt="" />
                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/home/iframe2.png" alt="" />
                                </div>
                                <div class="overlay-icon">
                                    <i class="fa fa-play-circle-o"></i>
                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/home/iframe3.png" alt="" />
                                </div>
                                <div class="overlay-icon">
                                    <i class="fa fa-play-circle-o"></i>
                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="video-gallery text-center">
                            <a href="#">
                                <div class="iframe-img">
                                    <img src="<?= Yii::$app->request->baseUrl ?>/images/home/iframe4.png" alt="" />
                                </div>
                                <div class="overlay-icon">
                                    <i class="fa fa-play-circle-o"></i>
                                </div>
                ...
                <div class="col-sm-3">
                    <div class="address">
                        <img src="<?= Yii::$app->request->baseUrl ?>/images/home/map.png" alt="" />
